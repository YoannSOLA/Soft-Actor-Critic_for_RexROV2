...
from uuv_control_interfaces.dp_controller_base_rl import DPControllerBaseRL


class DPPIDControllerBaseRL(DPControllerBaseRL):
    """
    ...
    def __init__(self, *args):
        ...
        DPControllerBaseRL.__init__(self, *args)
    ...
    def _reset_controller(self):
        super(DPPIDControllerBaseRL, self)._reset_controller()
        self._error_pose = np.zeros(6)
        self._int = np.zeros(6)
